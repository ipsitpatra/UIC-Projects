...
CREATE TABLE `doctor_login` (
  ...
  PRIMARY KEY (`User_ID`),
  KEY `fk_Doctor_Login_User_Verification1_idx` (`User_ID`),
  CONSTRAINT `fk_Doctor_Login_User_Verification1` FOREIGN KEY (`User_ID`) REFERENCES `user_verification` (`User_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-12-05  1:13:42
